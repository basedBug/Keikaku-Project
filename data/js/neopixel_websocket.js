...
function onMessage(message) {
	try {
		...
		if (data.neopixel) {
			const neopixel = data.neopixel;

			if (neopixel.color) {
				colorPicker.color.red = neopixel.color.r;
				colorPicker.color.green = neopixel.color.g;
				colorPicker.color.blue = neopixel.color.b;
				changeBackgroundColor(neopixel.color);
			}
		}
	} catch (error) {
		console.error(
